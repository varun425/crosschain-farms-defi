    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596.5, 'Get BNB tokens')}</li>
          ...
          <List>
            <li>{TranslateString(603, 'While the sale is live, commit your tokens to buy the IWO tokens')}</li>
          </List>
        ...
        <div>
          ...
          <div>
            <Title as="h2">{TranslateString(513, 'Want to launch your own IWO?')}</Title>
            <Text mb={3}>
              {TranslateString(
                514.5,
                'Launch your project with Knightswap, Binance Smart Chain’s fastest growing AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
